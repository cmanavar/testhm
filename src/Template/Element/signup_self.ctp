...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
            <title>Welcome To H-Men! Confirm Your Email</title>
    </head>
