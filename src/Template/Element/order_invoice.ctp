                                                                ...
                                                                <tbody>
                                                                            ...
                                                                            <table style="font-size:13px!important" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" valign="middle" style="font-size:13px;padding-left:10px">Order ID<br><span style="color:#156095!important"><strong>#663893706</strong></span></td>
                                                                                        <td align="left" valign="middle" style="font-size:13px;padding-left:10px">Order Status<br><span style="color:#156095!important"><strong>SCHEDULED</strong></span></td>
                                                                                        <td align="left" valign="middle" style="font-size:13px;padding-left:10px">Service<br><span style="color:#156095!important"><strong>Computer Repair</strong></span></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding-top:10px;padding-bottom:10px;padding-left:30px;padding-right:30px">
                                                                            ...
                                                                            Thank you for booking our Computer Repair service.
                                                                            <p style="margin-top:10px!important;margin-bottom:10px!important;float:left!important;clear:both!important">Please use this order id
                                                                                <span style="color:#156095!important">#663893706</span> 
                                                                                for further communication. One of our experts will attend to your request on 04-02-2018 between 
                                                                                <span class="aBn" data-term="goog_280542123" tabindex="0">
                                                                                    <span class="aQJ">
                                                                                        11:00 AM - 12:00 PM.
                                                                                    </span>
                                                                                </span>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="background-color:#f7f7f7;padding:30px">
                                                                                                <h3 style="font-size:13px!important;margin-bottom:9px!important;color:#156095!important;float:left!important;clear:both!important">Service Lists</h3>
                                                                                                <div style="width:100%;float:left">
                                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td style="padding:10px 0;border-bottom:solid 1px #156095; color: #156095" align="left" valign="top">1)
                                                                                                                    <span style="color:#156095!important">1 x  Computer Repair - Macbook - Generic Software Issues - Need - Anti Virus Installation </span>
                                                                                                                    <br>
                                                                                                                </td>
                                                                                                                <td colspan="2" style="padding:10px 0;border-bottom:solid 1px #156095;min-width:100px" align="right" valign="top">
