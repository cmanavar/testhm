...
// SHOW DATA INTO EDIT POPUP ON REDIRECTING FROM DASHBOARD
var inventid = $("#inv_dashboard").val();
if(inventid != "") {
    $('#InventoryEditModal').modal('show');
    var id = inventid;
    var url = $("#dashboard_editurl").attr('url');
    $.ajax({
        type: "POST",
        url: url,
        data: {id: id},
...
$('.InventoryAddBtn ').click(function () { // clear data when click on add new appointment
